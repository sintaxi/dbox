      ...
      return {
        ...
        uploadChunked: function (localPath, remotePath, options, cb) {
          ...
          var defaultOptions = {
              ...
              "onEndChunkUpload": function(status, reply, upload_id, chunkSize, offset) {} // this will get called right after each chunk is uploaded
          };
                    ...
                    self.putChunked(buffer, {
                      ...
                      if (status === 400) {
                        ...
                        if (options.onEndChunkUpload) {
                          options.onEndChunkUpload(status, reply, upload_id, chunkSize, offset);
                        }
                        return putChunks();
                      }
